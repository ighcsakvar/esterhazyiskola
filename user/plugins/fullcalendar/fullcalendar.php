...
class FullcalendarPlugin extends Plugin
{
    ...
    public function onPluginsInitialized()
    {
        ...
        $assets->addCss('plugin://fullcalendar/fc4/packages/core/custom.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/daygrid/main.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/timegrid/main.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/bootstrap/main.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/google-calendar/main.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/list/main.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/luxon/main.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/moment/main.css');
		$assets->addCss('plugin://fullcalendar/fc4/packages/timegrid/main.css');
		...
		$assets->addJs('plugin://fullcalendar/fc4/packages/timegrid/main.js');
		$assets->addJs('plugin://fullcalendar/fc4/packages/rrule/main.js');
		$assets->addJs('plugin://fullcalendar/fc4/packages/bootstrap/main.js');
		$assets->addJs('plugin://fullcalendar/fc4/packages/google-calendar/main.js');
		$assets->addJs('plugin://fullcalendar/fc4/packages/list/main.js');
        ...
        $language = $this->grav['language']->getDefault();
